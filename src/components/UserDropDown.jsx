...
const UserDropDown = ({ img, id }) => {
  ...
  const style = {
    mainDiv: ` z-50 flex flex-col absolute  profileDropDownZ   py-5  items-center justify-around bg-white shadow-md rounded-[10px] h-[300px] w-[300px] max_smm:h-[400px] z-50  top-[4.4rem] left-[-5rem] max_smm:left-[-16rem]`,
