...
export default function FindDevSkeleton() {
  const style = {
    mainDiv: ` relative animate-pulse h-[740px] pt-[6rem]	 wborder-solid-2  border-black flex flex-col gap-10  `,
    infoWrapper: `  relative  w-[100%] justify-around flex  p-5 rounded-[5px]   solid border-black   `,
    header: ` flex  h-[3rem] items-center justify-center gap-10 text-center bg-gray-200 p-1 rounded-[5px] shadow-md   text-3xl font-medium font-mono text-gray-500`,
    info: `text-gray-600`,
    ...
    icon: `   `,
    iconWrapper: `flex  w-[14rem] bg-gray-200 rounded-[20px] h-[2rem] items-center justify-center text-[1.2rem] gap-2`,
    skillsDiv: `pt-10`,
  }
  ...
  return (
    <div className={style.mainDiv}>
      ...
      <section className="flex w-[100%]  absolute bottom-2 justify-around items-center  ">
        <div className="w-[4rem] h-[4rem] rounded-[50%] bg-gray-200"></div>
        <div className="w-[4rem] h-[4rem] rounded-[50%] bg-gray-200"></div>
      </section>
    </div>
  )
