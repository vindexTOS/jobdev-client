...
const EducationInfo = () => {
  const { AddEducation, educationBlockCount, addToEducation } = UseMainContext()
  const style = {
  ...
  return (
    <div className={style.topDiv}>
      ...
      <button
        ...
        onClick={() => {
          AddEducation(), addToEducation()
        }}
      >
        <p className="text-gray-400">Add More Education</p>
